...
export const labelDemo: ComponentDemo = {
  ...
  html: `
    <div style="display: flex; flex-direction: column; gap: 1rem; width: 100%; max-width: 300px;">
      ...
      <input id="lbl-test" type="text" placeholder="Click label to focus me" style="padding: 10px; border-radius: 6px; border: 1px solid var(--hp-border); background: rgba(0,0,0,0.2); color: white;" />
    </div>
  `,
};
