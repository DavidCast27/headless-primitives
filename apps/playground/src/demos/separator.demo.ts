...
export const separatorDemo: ComponentDemo = {
  ...
  html: `
    <div style="width: 100%; border: 1px solid var(--border-color); padding: 2rem; border-radius: 12px; background: rgba(255,255,255,0.02);">
      <h3 style="margin-bottom: 0.5rem;">Section Title</h3>
      <p style="color: var(--text-secondary); font-size: 0.9rem;">Content above the separator.</p>
      
      <hp-separator class="separator" style="margin: 1.5rem 0;"></hp-separator>
      
      <p style="color: var(--text-secondary); font-size: 0.9rem;">Content below the separator.</p>
