...
Los componentes usan **Lit 3** (`HeadlessElement`) como base para reactividad declarativa con `@property` y `@customElement`. Lit es una capa mínima sobre Custom Elements nativos (~13kB) que garantiza consistencia y reduce boilerplate. Ver [ADR 0010](https://github.com/DavidCast27/headless-primitives/blob/main/docs/adr/0010-headlesselement-lit-migration.md).
