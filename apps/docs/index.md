...
hero:
  ...
  text: "El futuro es Vanilla."
  tagline: Librería radicalmente pura de Web Components. Totalmente agnóstica de frameworks. Con accesibilidad de primer nivel.
  image:
    src: /logo.png
    alt: Headless Primitives Logo
  actions:
    - theme: brand
      text: 🚀 Comenzar ahora
    ...
    - theme: alt
      text: Ver en GitHub
      link: https://github.com/DavidCast27/headless-primitives
